                    ...
                    switch((*world_ref)[absposx][posy].type){
                        ...
                        case 5:
                                if((*world_ref)[absposx][posy].blockdat==0){
                                    ...
                                    if((*world_ref)[absposx][posy-1].generated&&(*world_ref)[absposx][posy-1].type==5&&(*world_ref)[absposx][posy-1].blockdat!=16&&(*world_ref)[absposx][posy].blockdat>0){
                                            (*world_ref)[absposx][posy-1].blockdat+=1;
                                            (*world_ref)[absposx][posy].blockdat-=1;

                                    }
                                    else if((*world_ref)[absposx][posy].blockdat!=0){
                                        if((*world_ref)[absposx+1][posy].type==0&&(*world_ref)[absposx+1][posy].generated){
